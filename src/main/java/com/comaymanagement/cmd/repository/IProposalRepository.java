...
public interface IProposalRepository {
	public List<ProposalModel> findAllProposalApproveByMe(List<ApprovalStep> appSteps,List<Integer> proposalTypeIds, List<Integer> statusId, List<Integer> creatorIds,
